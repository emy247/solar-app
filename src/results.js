 ...
 return(
  ...
  <div className="results">
    ...
    <div className="system-output">
        <img src={location_energy} alt="" className="location-energy-icon"></img>
    ...
    <div className="info">
      ...
      <ul className="outputs">
          <li className="inclination1:">Inclination: <span className="output-angle inc">{optimal? data.inputs.mounting_system.fixed.slope.value: angle}°</span></li>
          <li className="azimuth1:">Azimuth: <span className="output-angle azi">{optimal? data.inputs.mounting_system.fixed.azimuth.value:aspect}°</span></li>
          <li className="total-loss1:">Total system loss: <span className="output-angle tot">{data.outputs.totals.fixed.l_total*-1}%</span></li>
      </ul>
